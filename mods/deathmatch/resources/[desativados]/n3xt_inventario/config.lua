...
config = {
    ...
    itens = {
        ...
        -- Outros |
        [56] = {nome="dirtymoney", peso=0, tipo="outros", maxitem=999999999, image="files/gfx/others/dinheirosujo.png"},
        [57] = {nome="capsula", peso=0, tipo="outros", maxitem=999999999, image="files/gfx/others/dinheirosujo.png"},
        [58] = {nome="polvora", peso=0, tipo="outros", maxitem=999999999, image="files/gfx/others/dinheirosujo.png"},
    },
