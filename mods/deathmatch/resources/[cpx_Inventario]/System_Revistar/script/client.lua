...
local dxfont0_RobotoRegular = dxCreateFont(":System_Revistar/assets/font/RobotoRegular.ttf", 13)
local dxfont1_RobotoRegular = dxCreateFont(":System_Revistar/assets/font/RobotoRegular.ttf", 11)
...
function renderAccept()
    ...
    dxDrawImage(PosX, 102, 425, 64, "assets/img/fundo.png", 0, 0, 0, tocolor(255,255,255,255), false)
    dxDrawImage((PosX + 15), 111, 49, 45, "assets/img/button.png", 0, 0, 0, tocolor(111, 33, 211,255), false)
    dxDrawImage((PosX + 77), 111, 49, 45, "assets/img/button.png", 0, 0, 0, tocolor(211, 33, 33,255), false)
    dxDrawText("E", (PosX + 35), 123, 1562, 167, tocolor(255, 255, 255, 255), 1.00, dxfont0_RobotoRegular, "left", "top", false, false, true, false, false)
    dxDrawText("U", (PosX + 96), 123, 1624, 167, tocolor(255, 255, 255, 255), 1.00, dxfont0_RobotoRegular, "left", "top", false, false, true, false, false)
    dxDrawText("Aperte [E] Para Aceitar a Revista\nou [U] Para Recusar", (PosX + 144), 115, 1870, 153, tocolor(255, 255, 255, 255), 1.00, dxfont1_RobotoRegular, "left", "top", false, false, true, false, false)
end
