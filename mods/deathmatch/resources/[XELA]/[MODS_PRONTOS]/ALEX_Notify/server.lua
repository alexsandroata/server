...
----------comandos---------
addCommandHandler(config.comandos['avisoadm'], function (player, _, ...)
...
addCommandHandler(config.comandos['avisopm'], function (player, _, ...)
...
addCommandHandler(config.comandos['avisomec'], function (player, _, ...)
...
addCommandHandler(config.comandos['avisohp'], function (player, _, ...)
...
-- addCommandHandler(config.comandos['avisoilegal'], function (player, _, ...)
