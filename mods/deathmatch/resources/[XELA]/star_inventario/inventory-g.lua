...
config = {
    ['Geral'] = {
        ...
        WeightStandard = 250; -- Peso padrão.
    ...
    ['Shops'] = {
        {
            position = {1897.286, -1760.048, 13.547, -1}; -- Posição {X, Y, Z}. [ UTILITÁRIOS POSTO CJ ]
        ...
        {
            position = {374.933, -2036.305, 7.83 -1}; -- Posição {X, Y, Z}. [ teste UTILITÁRIOS POSTO CJ ]
            color = {139, 0, 255, 255}; -- Cor {R, G, B}.
            items = { -- Itens.
                {name_item = 'Kit Reparo', item = 'kitreparo', price = 800}; -- Nome do Item, Nome do Item (GIVE), Preço.
                {name_item = 'Bandagem', item = 'bandagem', price = 1300}; -- Nome do Item, Nome do Item (GIVE), Preço.
                {name_item = 'JBL', item = 'jbl', price = 5000}; -- Nome do Item, Nome do Item (GIVE), Preço.
        ...
        {
            position = {1385.763, -1382.633, 13.716 -1}; -- Posição {X, Y, Z}. [ COMIDA PRACA ]
            color = {139, 0, 255, 0}; -- Cor {R, G, B}.
            items = { -- Itens.
