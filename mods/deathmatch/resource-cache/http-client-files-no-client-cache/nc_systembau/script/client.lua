...
function dxChest()
    ...
    roundedRectangle(741, 186, 62, 25, 5, tocolor(255, 0, 255, alpha), "#ff0000", 0, false) -- | Fundo Bau
    dxDrawText("BAU", 759, 190, 26, 18, tocolor(255, 255, 255, alpha), 1, poppins, "left", "top", false, false, false, false, false)
